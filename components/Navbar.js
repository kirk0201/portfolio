...
export default function Navbar(props) {
  ...
  return (
    <div className="fixed z-20 h-16 w-screen shadow-2xl lg:bg-white">
      <div className="relative left-1/2 -translate-x-1/2 bg-gray-300 py-5 lg:w-2/3 lg:bg-transparent">
        <div className="md:flex">
          <div className="flex justify-between bg-transparent px-10 text-center text-lg font-bold md:w-2/3 ">
            <div>
