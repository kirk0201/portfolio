      ...
      <article className="grid grid-cols-2 gap-10 py-5 px-10">
        ...
        <section>
          <section className="font-semibold">
            <article>
              넷플릭스 서비스의 테마를 오마주하여 영화 API를 이용한 영화정보와
              소개 및 예고편을 제공하는 웹서비스입니다.
            </article>
            <br />
            <article>
              Framer-motion이라는 애니메이션 라이브러리를 이용하여 시각적 효과에
              힘을 주어 생동감 있는 웹페이지를 제작하기 위해 노력했습니다.
              <br />
              Gradient를 사용하여 이미지와 Navbar 배경 색상이 다른 요소들과
              자연스럽게 어울리는 효과를 만들어 보았고, React-player를 사용하여
              처음으로 웹페이지에서 동영상을 재생할 수 있게 만들어보았고, 더
              자세한 영화 정보를 얻기 위해 영화를 선택할 때, 나타나는 설명창을
              Modal 창으로 구현하여 시각적으로 효과를 주었습니다.
              <br />
